...
public class Golem3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Knight.vidas<=0){
            NoPerseguir();
            anim.SetBool("Golem3Ataca", false);
        } 

        if(vidasGolemG<=0){
            isLive=false;
            rb2d.velocity = new Vector2(0,2); 
            anim.SetBool("Golem3Moviendose", false); 
            NoPerseguir();  
            anim.SetBool("Golem3Ataca", false);
            anim.SetBool("Golem3Muere", true); 
    ...
    {
        anim.SetBool("Golem3Moviendose", true); 
